    ...
    <div className="lg:w-4/5">
      ...
      <div className="md:mt-6 flex flex-col gap-5">
        {props.applications.map((application) => (
          <div
            key={application._id}
            className="white-bg flex flex-col sm:flex-row h-fit sm:py-0 py-5 items-center justify-between w-full shadow rounded-md overflow-hidden relative"
          >
            <div
            ...
            >
              ...
              <div className="details flex flex-col px-5 items-center sm:items-start">
