...
export default function Login(props) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (form === 0) {
      // Sign up
      const response = await fetch("/api/registerloginreset/register", {
        method: "POST",
        headers: {
      ...
      // Sign in
      const response = await fetch("/api/registerloginreset/login-user", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      <div className={form ? "" : "hidden"}>
        ...
        >
          <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div className="playfair flex items-center space-x-3 rtl:space-x-reverse my-5">
              <img
